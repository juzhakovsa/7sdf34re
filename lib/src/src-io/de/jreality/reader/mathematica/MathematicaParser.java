// $ANTLR 2.7.7 (2006-11-01): "mathematica.g" -> "MathematicaParser.java"$
...
*/
	...
	private final void graphics3D() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			case OPEN_BRACE:
			{
				...
				{
					objectList(startApp,defaultEdgeForm);
					break;
				}
				case CLOSE_BRACE:
				{
			...
			case LITERAL_SurfaceColor:
			{
				faceThing(startApp,defaultEdgeForm);
				break;
			}
			case LITERAL_Text:
			case LITERAL_Point:
	...
	private final void listOfGraphics() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			case 7:
			{
				...
				_loop7:
				do {
					if ((LA(1)==COLON) && ((LA(2) >= OPEN_BRACE && LA(2) <= 7))) {
						match(COLON);
						listOfGraphics();
					}
					else {
	...
	private final void egal() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			_loop111:
			do {
				if ((_tokenSet_5.member(LA(1))) && ((LA(2) >= OPEN_BRACE && LA(2) <= WS_))) {
					{
					match(_tokenSet_5);
					}
				}
			...
			case OPEN_BRACE:
			{
				...
				match(CLOSE_BRACE);
				{
				if (((LA(1) >= OPEN_BRACE && LA(1) <= WS_)) && (_tokenSet_7.member(LA(2)))) {
					egal();
				}
				else if ((LA(1)==CLOSE_BRACE||LA(1)==COLON||LA(1)==CLOSE_BRACKET) && (_tokenSet_8.member(LA(2)))) {
				}
				else {
					throw new NoViableAltException(LT(1), getFilename());
				}
			...
			do {
				if ((LA(1)==COLON) && (LA(2)==LITERAL_Polygon||LA(2)==LITERAL_SurfaceColor)) {
					...
					case LITERAL_SurfaceColor:
					{
						{
						app2=faceColor(app2);
						colorFlag=true; fC=MathematicaHelper.getFColor(app2,fCDefault);
						}
						break;
					}
					case LITERAL_Polygon:
			...
			do {
				if ((LA(1)==COLON) && (_tokenSet_9.member(LA(2)))) {
					...
					case LITERAL_CMYKColor:
					{
						{
						plC=color();
						colorFlag=true; app2=MathematicaHelper.setPLColor(app2,plC);
						}
						break;
					}
					case LITERAL_Line:
	...
	private final void dumb() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			case WS_:
			{
				...
				_loop138:
				do {
					if ((_tokenSet_12.member(LA(1))) && ((LA(2) >= OPEN_BRACE && LA(2) <= WS_))) {
						{
						match(_tokenSet_12);
						}
					}
				...
				{
				if ((LA(1)==OPEN_BRACE) && (_tokenSet_13.member(LA(2)))) {
					match(OPEN_BRACE);
					{
					_loop141:
					do {
				...
				else if ((LA(1)==OPEN_BRACKET) && (_tokenSet_14.member(LA(2)))) {
					match(OPEN_BRACKET);
					{
					_loop143:
					do {
				...
				else if (((LA(1) >= OPEN_BRACE && LA(1) <= WS_)) && ((LA(2) >= OPEN_BRACE && LA(2) <= WS_))) {
				}
				else {
					throw new NoViableAltException(LT(1), getFilename());
				}
...
*/
		...
		try {      // for error handling
			...
			case INTEGER_THING:
			{
				...
				if ((LA(1)==DOT) && (_tokenSet_17.member(LA(2)))) {
					match(DOT);
					{
					if ((LA(1)==INTEGER_THING) && (_tokenSet_17.member(LA(2)))) {
						s2 = LT(1);
						match(INTEGER_THING);
	...
	private static final long[] mk_tokenSet_8() {
		long[] data = { -32212254606L, 15L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_8 = new BitSet(mk_tokenSet_8());
	private static final long[] mk_tokenSet_9() {
		long[] data = { 15794176L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_9 = new BitSet(mk_tokenSet_9());
	private static final long[] mk_tokenSet_10() {
		long[] data = { 15761408L, 0L};
		return data;
	}
	...
	private static final long[] mk_tokenSet_17() {
		long[] data = { 17179869792L, 1472L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_17 = new BitSet(mk_tokenSet_17());
	private static final long[] mk_tokenSet_18() {
		long[] data = { 17179869792L, 4032L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_18 = new BitSet(mk_tokenSet_18());
	private static final long[] mk_tokenSet_19() {
		long[] data = { 17179869792L, 1984L, 0L, 0L};
		return data;
	}
