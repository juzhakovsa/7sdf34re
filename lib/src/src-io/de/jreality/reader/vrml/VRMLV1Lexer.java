...
public VRMLV1Lexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("vertexOrdering", this), new Integer(67));
	literals.put(new ANTLRHashString("TextureCoordinate2", this), new Integer(65));
	...
	literals.put(new ANTLRHashString("filename", this), new Integer(56));
	literals.put(new ANTLRHashString("Info", this), new Integer(40));
	literals.put(new ANTLRHashString("MaterialBinding", this), new Integer(50));
	literals.put(new ANTLRHashString("Transform", this), new Integer(75));
	literals.put(new ANTLRHashString("color", this), new Integer(87));
	literals.put(new ANTLRHashString("Cube", this), new Integer(23));
	literals.put(new ANTLRHashString("MatrixTransform", this), new Integer(71));
	...
	literals.put(new ANTLRHashString("wrapT", this), new Integer(59));
	...
	literals.put(new ANTLRHashString("rgb", this), new Integer(49));
	literals.put(new ANTLRHashString("shapeType", this), new Integer(68));
	literals.put(new ANTLRHashString("WWWInline", this), new Integer(7));
	literals.put(new ANTLRHashString("faceType", this), new Integer(69));
	...
	literals.put(new ANTLRHashString("creaseAngle", this), new Integer(70));
	literals.put(new ANTLRHashString("wrapS", this), new Integer(58));
	...
	literals.put(new ANTLRHashString("ShapeHints", this), new Integer(66));
	...
	literals.put(new ANTLRHashString("center", this), new Integer(64));
	literals.put(new ANTLRHashString("NormalBinding", this), new Integer(54));
	...
	literals.put(new ANTLRHashString("image", this), new Integer(57));
	...
	literals.put(new ANTLRHashString("Texture2Transform", this), new Integer(60));
	...
	literals.put(new ANTLRHashString("translation", this), new Integer(61));
	literals.put(new ANTLRHashString("TRUE", this), new Integer(98));
	literals.put(new ANTLRHashString("scaleFactor", this), new Integer(63));
	literals.put(new ANTLRHashString("PerspectiveCamera", this), new Integer(78));
	literals.put(new ANTLRHashString("Texture2", this), new Integer(55));
	...
	literals.put(new ANTLRHashString("value", this), new Integer(51));
	...
	literals.put(new ANTLRHashString("BaseColor", this), new Integer(48));
	...
	literals.put(new ANTLRHashString("Scale", this), new Integer(74));
	literals.put(new ANTLRHashString("matrix", this), new Integer(72));
	literals.put(new ANTLRHashString("point", this), new Integer(39));
	literals.put(new ANTLRHashString("vector", this), new Integer(53));
	...
	literals.put(new ANTLRHashString("scaleOrientation", this), new Integer(76));
	literals.put(new ANTLRHashString("PointSet", this), new Integer(33));
	literals.put(new ANTLRHashString("Normal", this), new Integer(52));
	...
	literals.put(new ANTLRHashString("Rotation", this), new Integer(73));
	literals.put(new ANTLRHashString("rotation", this), new Integer(62));
}
...
tryAgain:
		...
		try {   // for char stream error handling
			try {   // for lexical error handling
				...
				default:
					...
					else if (((LA(1)=='#') && (LA(2)=='I'||LA(2)=='V'))&&(getLine()==1)) {
						mHEADER(true);
						theRetToken=_returnToken;
					}
	...
	private static final long[] mk_tokenSet_2() {
		long[] data = { -118257629528064L, 5188146769791287295L, 0L, 0L, 0L};
		return data;
	}
